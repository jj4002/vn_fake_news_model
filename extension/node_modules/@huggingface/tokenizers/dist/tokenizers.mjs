...
var PUNCTUATION_ONLY_REGEX = new RegExp(
  `^[${PUNCTUATION_REGEX}]+$`,
  "gu"
);
...
var Metaspace = class extends PreTokenizer_default {
  ...
  pre_tokenize_text(text, options) {
    ...
    if (
      ...
      this.add_prefix_space && !normalized.startsWith(this.replacement) && // and (2) either:
...
var ByteLevel2 = class extends PostProcessor_default {
  ...
  post_process(tokens, tokens_pair = null) {
    const merged_tokens = !tokens_pair ? tokens : merge_arrays(tokens, tokens_pair);
...
var Tokenizer = class {
  constructor(tokenizer, config) {
    ...
    this.added_tokens_splitter = new DictionarySplitter_default(
  ...
  encode_text(text) {
    ...
    return sections.flatMap((processed_text, section_index) => {
      ...
      const section_tokens = this.pre_tokenizer !== null ? this.pre_tokenizer(processed_text, {
        section_index
      }) : [processed_text];
